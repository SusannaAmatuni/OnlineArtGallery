      ...
      int artistID;
        ArrayList<ProductCl> products= new ArrayList<ProductCl>();
         ...
         if(product!= null){
           ...
           {
              artistID = (Integer)session.getAttribute("artistID"); }
        ...
        ArtistCl artist = ArtistDB.selectArtist(artistID);
        
        session.setAttribute("artist", artist);
        products = ProductDB.selectProductsForArtist( artistID);
        session.setAttribute("artistproducts",products);
