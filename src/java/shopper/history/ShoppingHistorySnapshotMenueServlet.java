 ...
 * @author HP_Owner
 */
public class ShoppingHistorySnapshotMenueServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
       ...
       for(int i=0 ; i<cookies.length;i++) {
           ...
           if(cookie.getName().equals("usernameCookie")) {
                ...
                customer = CustomerDB.selectCustomerMember(usernameCookie);
       ...
       request.setAttribute("alllineitems",alllineitems);    
           ...
           String url = "/history/shoppinghistoryallmenue.jsp";
