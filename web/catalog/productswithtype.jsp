<%-- 
    Document   : productswithtype
    Created on : Dec 15, 2010, 9:22:32 AM
    Author     : HP_Owner
--%>
...
<td width="50%" valign="middle" align="absmiddle" bgcolor="#00FFFF" class=middlecolumn>
   
   
    
    <c:forEach   var="item" items="${products}" varStatus="itemsCount" >
        <em><p><br><br>
            <a href ="<c:url value='product?productCode=${item.productCode}' />"><img height="40%" width="40%" src="/OnlineShopper2/images/${item.productCode}.JPG" align="bottom" ></a><br><p>   
       ...
       <a href="<c:url value='checkcustomerforwishlist?productCode=${item.productCode}' />"> Add to My Wishlist<br></a>
        <a href="<c:url value='checkcustomerforwishlist' />"> My Wishlist<br><p></a><hr size="1">
</p></em>
 </c:forEach>
 <a href="arttype?arttype=${arttype}"><b>&#094;Top</b></a>
</td>
